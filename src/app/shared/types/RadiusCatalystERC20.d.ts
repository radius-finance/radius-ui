...
interface RadiusCatalystERC20Interface extends ethers.utils.Interface {
  functions: {
    "DEFAULT_ADMIN_ROLE()": FunctionFragment;
    "RADIUS_ERC20TOKEN_ADMIN()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "RADIUS_ERC20TOKEN_ADMIN",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class RadiusCatalystERC20 extends Contract {
  ...
  interface: RadiusCatalystERC20Interface;
  ...
  functions: {
    ...
    RADIUS_ERC20TOKEN_ADMIN(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    RADIUS_ERC20TOKEN_ADMIN(overrides?: CallOverrides): Promise<BigNumber>;
