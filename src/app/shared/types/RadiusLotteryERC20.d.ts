...
interface RadiusLotteryERC20Interface extends ethers.utils.Interface {
  functions: {
...
export class RadiusLotteryERC20 extends Contract {
  ...
  interface: RadiusLotteryERC20Interface;
