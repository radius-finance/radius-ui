...
interface TestTokenForgeInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setTargetMintAmount(uint256)": FunctionFragment;
    "setTargetMintSpan(uint256)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "setTargetMintAmount",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "setTargetMintSpan",
    values: [BigNumberish]
  ): string;
...
export class TestTokenForge extends Contract {
  ...
  interface: TestTokenForgeInterface;
