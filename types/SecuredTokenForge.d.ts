...
interface SecuredTokenForgeInterface extends ethers.utils.Interface {
  functions: {
...
export class SecuredTokenForge extends Contract {
  ...
  interface: SecuredTokenForgeInterface;
