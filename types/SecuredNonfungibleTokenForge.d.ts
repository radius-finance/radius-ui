...
interface SecuredNonfungibleTokenForgeInterface extends ethers.utils.Interface {
  functions: {
...
export class SecuredNonfungibleTokenForge extends Contract {
  ...
  interface: SecuredNonfungibleTokenForgeInterface;
