...
interface UniqueItemTokenForgeInterface extends ethers.utils.Interface {
  functions: {
...
export class UniqueItemTokenForge extends Contract {
  ...
  interface: UniqueItemTokenForgeInterface;
