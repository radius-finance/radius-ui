...
interface RareItemTokenForgeInterface extends ethers.utils.Interface {
  functions: {
    ...
    "foundQuantity(uint8)": FunctionFragment;
    ...
    "maxQuantity(uint8)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "foundQuantity",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export class RareItemTokenForge extends Contract {
  ...
  interface: RareItemTokenForgeInterface;
