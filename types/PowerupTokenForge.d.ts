...
interface PowerupTokenForgeInterface extends ethers.utils.Interface {
  functions: {
...
export class PowerupTokenForge extends Contract {
  ...
  interface: PowerupTokenForgeInterface;
